  ...
  return (
    <>
      <nav className="navbar">
        ...
        {/* Navigation & Profile container (Slide-out drawer on Mobile, Inline flex on Desktop) */}
        <div className={`navbar-menu-container ${isMobileMenuOpen ? "open" : ""}`}>
          <div className="navbar-menu-header">
            <span className="navbar-menu-title">Menu</span>
          ...
          <ul className="navbar-nav">
            ...
            <li>
              <button
                onClick={() => handleTabClick("rateLive")}
